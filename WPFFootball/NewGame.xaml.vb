...
Public Class NewGame
    ...
    private sub GetTeamValues(TeamNum As integer)
        ...
        TeamStaff.Inlines.Add(New LineBreak)
        teamstaff.Inlines.Add(New Run() _
                                 With {.FontSize = 24,
                                 .Text =
        ...
        SalaryCap.Inlines.Add(New Run() With {.FontSize = 40, .Foreground = MyVM.MyTrimColor, .Text = "Team Salary Cap Info:"})
    ...
    Private Sub LoadTeamSchedule(TeamID As integer)
        ...
        TeamSchedule.Inlines.Add(New Run() With {.FontSize = 32, .Foreground = MyVM.MyTrimColor, .Text = "Team Schedule"})
        ...
        while SR.EndOfStream <> True 'reads through the file
            ...
            if linestring.Contains(String.Format("({0}) vs.", TeamID)) then 'This is a home game
                ...
                TeamSchedule.Inlines.Add(New Run() _
                                            ...
                                            .Text =
                                            string.Format("Week {0}: Vs. {1}", Week, GetEnumDescription(MyVM.TeamEnumList))})
                TeamSchedule.Inlines.Add(New LineBreak)
            ...
            ElseIf lineString.Contains(string.Format("({0})", TeamID)) Then 'Away game
                ...
                TeamSchedule.Inlines.Add(New Run() _
                                            ...
                                            .Text =
                                            string.Format("Week {0}: At {1}", Week, GetEnumDescription(MyVM.TeamEnumList))})
                TeamSchedule.Inlines.Add(New LineBreak)
